			...
			resource: {
				...
				api: {
					...
					service: {
						...
						dependencies: ["crypto-lib", "logger", "user-store", "rate-limiter"],
					},
					relatedItems: [
...
const deepestValue =
	complexNestedObject.system.component.resource.api.service.module.component.subComponent
		.configuration.finalValue
